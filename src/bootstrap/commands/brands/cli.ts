...
import type { GetBrandsRequest, GetBrandsResponse } from '../../../generated/t_tech/invest/grpc/instruments';
...
async function runBrandsCommand(
  ...
  try {
    const response = await sdk.instruments.getBrands({ paging: undefined });

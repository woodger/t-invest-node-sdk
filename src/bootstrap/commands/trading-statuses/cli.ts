...
export function tradingStatuses(argv: CliArgs): Promise<string> {
  return runTradingStatusesCommand(
    parseTradingStatusesOptions(argv),
    defaultTradingStatusesSdkFactory
  );
}

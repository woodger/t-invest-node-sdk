/**
 * Декларативный каталог CLI-справки.
 *
 * Здесь допустимы только статические контракты команд, usage и examples.
 * Здесь не должно быть разбора аргументов, rendering или SDK runtime wiring.
 */
...
export const commandHelp = {
  ...
  'dev compile-proto': {
    ...
    notes: [
      ...
      'Runs the pinned protoc compiler and ts-proto plugin from local npm dependencies.',

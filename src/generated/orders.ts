  ...
  fromJSON(object: any): TradesStreamRequest {
    return {
      ...
      pingDelayMs: isSet(object.pingDelayMs)
        ...
        : isSet(object.ping_delay_ms)
        ? globalThis.Number(object.ping_delay_ms)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): TradesStreamResponse {
    return {
      orderTrades: isSet(object.orderTrades)
        ...
        : isSet(object.order_trades)
        ? OrderTrades.fromJSON(object.order_trades)
        : undefined,
  ...
  fromJSON(object: any): PostOrderRequest {
    return {
      ...
      timeInForce: isSet(object.timeInForce)
        ...
        ? timeInForceTypeFromJSON(object.time_in_force)
        : 0,
  ...
  fromJSON(object: any): PostOrderResponse {
    return {
      ...
      executionReportStatus: isSet(object.executionReportStatus)
        ...
        : isSet(object.execution_report_status)
        ? orderExecutionReportStatusFromJSON(object.execution_report_status)
        : 0,
      ...
      lotsExecuted: isSet(object.lotsExecuted)
        ? globalThis.Number(object.lotsExecuted)
        : isSet(object.lots_executed)
        ? globalThis.Number(object.lots_executed)
        : 0,
      initialOrderPrice: isSet(object.initialOrderPrice)
        ? MoneyValue.fromJSON(object.initialOrderPrice)
        : isSet(object.initial_order_price)
        ? MoneyValue.fromJSON(object.initial_order_price)
        : undefined,
      executedOrderPrice: isSet(object.executedOrderPrice)
        ? MoneyValue.fromJSON(object.executedOrderPrice)
        : isSet(object.executed_order_price)
        ? MoneyValue.fromJSON(object.executed_order_price)
        : undefined,
      ...
      initialCommission: isSet(object.initialCommission)
        ...
        : isSet(object.initial_commission)
        ? MoneyValue.fromJSON(object.initial_commission)
        : undefined,
      executedCommission: isSet(object.executedCommission)
        ? MoneyValue.fromJSON(object.executedCommission)
        : isSet(object.executed_commission)
        ? MoneyValue.fromJSON(object.executed_commission)
        : undefined,
      ...
      initialSecurityPrice: isSet(object.initialSecurityPrice)
        ...
        : isSet(object.initial_security_price)
        ? MoneyValue.fromJSON(object.initial_security_price)
        : undefined,
      orderType: isSet(object.orderType)
        ? orderTypeFromJSON(object.orderType)
        : isSet(object.order_type)
      ...
      initialOrderPricePt: isSet(object.initialOrderPricePt)
        ...
        : isSet(object.initial_order_price_pt)
        ? Quotation.fromJSON(object.initial_order_price_pt)
        : undefined,
      instrumentUid: isSet(object.instrumentUid)
        ? globalThis.String(object.instrumentUid)
        : isSet(object.instrument_uid)
  ...
  fromJSON(object: any): PostOrderAsyncResponse {
    return {
      ...
      tradeIntentId: isSet(object.tradeIntentId)
        ? globalThis.String(object.tradeIntentId)
        : isSet(object.trade_intent_id)
        ? globalThis.String(object.trade_intent_id)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): CancelOrderRequest {
    return {
      ...
      orderIdType: isSet(object.orderIdType)
        ...
        : isSet(object.order_id_type)
        ? orderIdTypeFromJSON(object.order_id_type)
        : undefined,
    };
  },
...
export const GetOrdersRequest: MessageFns<GetOrdersRequest> = {
  encode(message: GetOrdersRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.advancedFilters !== undefined) {
      GetOrdersRequest_GetOrdersRequestFilters.encode(message.advancedFilters, writer.uint32(18).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): GetOrdersRequest {
    return {
      ...
      advancedFilters: isSet(object.advancedFilters)
        ...
        : isSet(object.advanced_filters)
        ? GetOrdersRequest_GetOrdersRequestFilters.fromJSON(object.advanced_filters)
        : undefined,
    };
  },
  ...
  fromPartial(object: DeepPartial<GetOrdersRequest>): GetOrdersRequest {
    const message = createBaseGetOrdersRequest();
    message.accountId = object.accountId ?? "";
    message.advancedFilters = (object.advancedFilters !== undefined && object.advancedFilters !== null)
      ? GetOrdersRequest_GetOrdersRequestFilters.fromPartial(object.advancedFilters)
      : undefined;
    return message;
  },
};
...
export const GetOrdersRequest_GetOrdersRequestFilters: MessageFns<GetOrdersRequest_GetOrdersRequestFilters> = {
  encode(message: GetOrdersRequest_GetOrdersRequestFilters, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetOrdersRequest_GetOrdersRequestFilters {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  fromJSON(object: any): GetOrdersRequest_GetOrdersRequestFilters {
    return {
      ...
      executionStatus: globalThis.Array.isArray(object?.executionStatus)
        ...
        : globalThis.Array.isArray(object?.execution_status)
        ? object.execution_status.map((e: any) => orderExecutionReportStatusFromJSON(e))
        : [],
    };
  },
  ...
  create(base?: DeepPartial<GetOrdersRequest_GetOrdersRequestFilters>): GetOrdersRequest_GetOrdersRequestFilters {
    return GetOrdersRequest_GetOrdersRequestFilters.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetOrdersRequest_GetOrdersRequestFilters>): GetOrdersRequest_GetOrdersRequestFilters {
    const message = createBaseGetOrdersRequest_GetOrdersRequestFilters();
  ...
  fromJSON(object: any): OrderState {
    return {
      ...
      serviceCommission: isSet(object.serviceCommission)
        ...
        : isSet(object.service_commission)
        ? MoneyValue.fromJSON(object.service_commission)
        : undefined,
      ...
      orderDate: isSet(object.orderDate)
        ...
        : isSet(object.order_date)
        ? fromJsonTimestamp(object.order_date)
        : undefined,
      instrumentUid: isSet(object.instrumentUid)
        ? globalThis.String(object.instrumentUid)
        : isSet(object.instrument_uid)
  ...
  fromJSON(object: any): OrderStage {
    return {
      ...
      executionTime: isSet(object.executionTime)
        ...
        : isSet(object.execution_time)
        ? fromJsonTimestamp(object.execution_time)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): GetMaxLotsResponse {
    return {
      ...
      buyLimits: isSet(object.buyLimits)
        ...
        : isSet(object.buy_limits)
        ? GetMaxLotsResponse_BuyLimitsView.fromJSON(object.buy_limits)
        : undefined,
      buyMarginLimits: isSet(object.buyMarginLimits)
        ? GetMaxLotsResponse_BuyLimitsView.fromJSON(object.buyMarginLimits)
        : isSet(object.buy_margin_limits)
        ? GetMaxLotsResponse_BuyLimitsView.fromJSON(object.buy_margin_limits)
        : undefined,
      sellLimits: isSet(object.sellLimits)
        ? GetMaxLotsResponse_SellLimitsView.fromJSON(object.sellLimits)
        : isSet(object.sell_limits)
        ? GetMaxLotsResponse_SellLimitsView.fromJSON(object.sell_limits)
        : undefined,
      sellMarginLimits: isSet(object.sellMarginLimits)
        ? GetMaxLotsResponse_SellLimitsView.fromJSON(object.sellMarginLimits)
        : isSet(object.sell_margin_limits)
        ? GetMaxLotsResponse_SellLimitsView.fromJSON(object.sell_margin_limits)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): GetMaxLotsResponse_BuyLimitsView {
    return {
      buyMoneyAmount: isSet(object.buyMoneyAmount)
        ...
        : isSet(object.buy_money_amount)
        ? Quotation.fromJSON(object.buy_money_amount)
        : undefined,
      buyMaxLots: isSet(object.buyMaxLots)
        ? globalThis.Number(object.buyMaxLots)
        : isSet(object.buy_max_lots)
        ? globalThis.Number(object.buy_max_lots)
        : 0,
      buyMaxMarketLots: isSet(object.buyMaxMarketLots)
        ? globalThis.Number(object.buyMaxMarketLots)
        : isSet(object.buy_max_market_lots)
        ? globalThis.Number(object.buy_max_market_lots)
        : 0,
    };
  },
  ...
  fromJSON(object: any): GetMaxLotsResponse_SellLimitsView {
    return {
      sellMaxLots: isSet(object.sellMaxLots)
        ...
        : isSet(object.sell_max_lots)
        ? globalThis.Number(object.sell_max_lots)
        : 0,
    };
  },
  ...
  fromJSON(object: any): GetOrderPriceResponse {
    return {
      ...
      initialOrderAmount: isSet(object.initialOrderAmount)
        ...
        : isSet(object.initial_order_amount)
        ? MoneyValue.fromJSON(object.initial_order_amount)
        : undefined,
      lotsRequested: isSet(object.lotsRequested)
        ? globalThis.Number(object.lotsRequested)
        : isSet(object.lots_requested)
      ...
      executedCommissionRub: isSet(object.executedCommissionRub)
        ...
        : isSet(object.executed_commission_rub)
        ? MoneyValue.fromJSON(object.executed_commission_rub)
        : undefined,
      serviceCommission: isSet(object.serviceCommission)
        ? MoneyValue.fromJSON(object.serviceCommission)
        : isSet(object.service_commission)
      ...
      dealCommission: isSet(object.dealCommission)
        ...
        : isSet(object.deal_commission)
        ? MoneyValue.fromJSON(object.deal_commission)
        : undefined,
      extraBond: isSet(object.extraBond)
        ? GetOrderPriceResponse_ExtraBond.fromJSON(object.extraBond)
        : isSet(object.extra_bond)
        ? GetOrderPriceResponse_ExtraBond.fromJSON(object.extra_bond)
        : undefined,
      extraFuture: isSet(object.extraFuture)
        ? GetOrderPriceResponse_ExtraFuture.fromJSON(object.extraFuture)
        : isSet(object.extra_future)
        ? GetOrderPriceResponse_ExtraFuture.fromJSON(object.extra_future)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): GetOrderPriceResponse_ExtraBond {
    return {
      ...
      nominalConversionRate: isSet(object.nominalConversionRate)
        ...
        : isSet(object.nominal_conversion_rate)
        ? Quotation.fromJSON(object.nominal_conversion_rate)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): GetOrderPriceResponse_ExtraFuture {
    return {
      initialMargin: isSet(object.initialMargin)
        ...
        ? MoneyValue.fromJSON(object.initial_margin)
        : undefined,
    };
  },
...
export const OrderStateStreamRequest: MessageFns<OrderStateStreamRequest> = {
  ...
  fromJSON(object: any): OrderStateStreamRequest {
    return {
      accounts: globalThis.Array.isArray(object?.accounts) ? object.accounts.map((e: any) => globalThis.String(e)) : [],
      pingDelayMillis: isSet(object.pingDelayMillis)
        ? globalThis.Number(object.pingDelayMillis)
        : isSet(object.ping_delay_millis)
        ? globalThis.Number(object.ping_delay_millis)
        : undefined,
    };
  },
...
export const OrderStateStreamResponse: MessageFns<OrderStateStreamResponse> = {
  encode(message: OrderStateStreamResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.stopOrderState !== undefined) {
      OrderStateStreamResponse_StopOrderState.encode(message.stopOrderState, writer.uint32(34).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): OrderStateStreamResponse {
    return {
      orderState: isSet(object.orderState)
        ...
        : isSet(object.order_state)
        ? OrderStateStreamResponse_OrderState.fromJSON(object.order_state)
        : undefined,
      ping: isSet(object.ping) ? Ping.fromJSON(object.ping) : undefined,
      subscription: isSet(object.subscription) ? SubscriptionResponse.fromJSON(object.subscription) : undefined,
      stopOrderState: isSet(object.stopOrderState)
        ? OrderStateStreamResponse_StopOrderState.fromJSON(object.stopOrderState)
        : isSet(object.stop_order_state)
        ? OrderStateStreamResponse_StopOrderState.fromJSON(object.stop_order_state)
        : undefined,
    };
  },
  ...
  fromPartial(object: DeepPartial<OrderStateStreamResponse>): OrderStateStreamResponse {
    ...
    message.subscription = (object.subscription !== undefined && object.subscription !== null)
      ? SubscriptionResponse.fromPartial(object.subscription)
      : undefined;
    message.stopOrderState = (object.stopOrderState !== undefined && object.stopOrderState !== null)
      ? OrderStateStreamResponse_StopOrderState.fromPartial(object.stopOrderState)
      : undefined;
    return message;
  },
};
...
export const OrderStateStreamResponse_OrderState: MessageFns<OrderStateStreamResponse_OrderState> = {
  ...
  fromJSON(object: any): OrderStateStreamResponse_OrderState {
    return {
      ...
      orderRequestId: isSet(object.orderRequestId)
        ...
        ? globalThis.String(object.order_request_id)
        : undefined,
      clientCode: isSet(object.clientCode)
        ? globalThis.String(object.clientCode)
        : isSet(object.client_code)
        ? globalThis.String(object.client_code)
        : "",
      createdAt: isSet(object.createdAt)
        ? fromJsonTimestamp(object.createdAt)
        : isSet(object.created_at)
      ...
      statusInfo: isSet(object.statusInfo)
        ...
        : isSet(object.status_info)
        ? orderStateStreamResponse_StatusCauseInfoFromJSON(object.status_info)
        : undefined,
      ticker: isSet(object.ticker) ? globalThis.String(object.ticker) : "",
      classCode: isSet(object.classCode)
        ? globalThis.String(object.classCode)
      ...
      accountId: isSet(object.accountId)
        ...
        ? globalThis.String(object.account_id)
        : "",
      tradeOrderId: isSet(object.tradeOrderId)
        ? globalThis.String(object.tradeOrderId)
        : isSet(object.trade_order_id)
        ? globalThis.String(object.trade_order_id)
        : "",
      initialOrderPrice: isSet(object.initialOrderPrice)
        ? MoneyValue.fromJSON(object.initialOrderPrice)
        : isSet(object.initial_order_price)
      ...
      orderPrice: isSet(object.orderPrice)
        ...
        ? MoneyValue.fromJSON(object.order_price)
        : undefined,
      ...
      lotsExecuted: isSet(object.lotsExecuted)
        ...
        ? globalThis.Number(object.lots_executed)
        : 0,
      lotsLeft: isSet(object.lotsLeft)
        ? globalThis.Number(object.lotsLeft)
        : isSet(object.lots_left)
        ? globalThis.Number(object.lots_left)
        : 0,
      lotsCancelled: isSet(object.lotsCancelled)
        ? globalThis.Number(object.lotsCancelled)
        : isSet(object.lots_cancelled)
        ? globalThis.Number(object.lots_cancelled)
        : 0,
  ...
  fromPartial(object: DeepPartial<OrderStateStreamResponse_OrderState>): OrderStateStreamResponse_OrderState {
    ...
    message.orderType = object.orderType ?? 0;
    message.accountId = object.accountId ?? "";
    message.tradeOrderId = object.tradeOrderId ?? "";
    message.initialOrderPrice = (object.initialOrderPrice !== undefined && object.initialOrderPrice !== null)
      ? MoneyValue.fromPartial(object.initialOrderPrice)
      : undefined;
...
export const OrderStateStreamResponse_StopOrderState: MessageFns<OrderStateStreamResponse_StopOrderState> = {
  encode(message: OrderStateStreamResponse_StopOrderState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.stopPrice !== undefined) {
      MoneyValue.encode(message.stopPrice, writer.uint32(50).fork()).join();
    }
    if (message.orderType !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): OrderStateStreamResponse_StopOrderState {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  create(base?: DeepPartial<OrderStateStreamResponse_StopOrderState>): OrderStateStreamResponse_StopOrderState {
    return OrderStateStreamResponse_StopOrderState.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<OrderStateStreamResponse_StopOrderState>): OrderStateStreamResponse_StopOrderState {
    const message = createBaseOrderStateStreamResponse_StopOrderState();
...
export const OrdersStreamServiceDefinition = {
  ...
  methods: {
    ...
    tradesStream: {
      name: "TradesStream",
      requestType: TradesStreamRequest as typeof TradesStreamRequest,
      requestStream: false,
      responseType: TradesStreamResponse as typeof TradesStreamResponse,
      responseStream: true,
      options: {},
    },
    /**
    ...
    orderStateStream: {
      ...
      requestType: OrderStateStreamRequest as typeof OrderStateStreamRequest,
      requestStream: false,
      responseType: OrderStateStreamResponse as typeof OrderStateStreamResponse,
      responseStream: true,
      options: {},
    },
  },

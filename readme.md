...
```sh
yarn add "git+ssh://git@github.com/woodger/tinkoff-invest-node-sdk.git#0.3.5"
```
...
Для версии `0.3.5` Git tag остается `0.3.5` по исторической схеме проекта, а
GitHub Release может называться `v0.3.5`. Release notes берутся из одноименного

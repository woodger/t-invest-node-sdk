...
- Для T-Invest proto-контрактов версии 1.49 и производного generated-кода
  ...
  `ru.tinkoff.piapi:java-sdk-grpc-contract:1.49`. Полный текст лицензии уже
  включён в package archive; MIT License продолжает применяться только к
  собственному коду SDK.

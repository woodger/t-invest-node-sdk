...
export declare function createSdkMiddleware(trackLimits: boolean, throttle: Throttle): <Request, Response>(call: ClientMiddlewareCall<Request, Response, CallOptions>, options: CallOptions) => AsyncGenerator<Awaited<Response>, void | Awaited<Response>, undefined>;

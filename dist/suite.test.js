    ...
    (0, node_test_1.describe)('removeCompiledTestsWithoutSource', () => {
        (0, node_test_1.test)('deletes stale compiled tests and keeps runnable tests', async () => {
            await withTempProject(async ({ projectDir, sourceDir, distDir }) => {
                ...
                node_assert_1.default.deepStrictEqual(runnableFiles, [runnableCompiled]);
                node_assert_1.default.strictEqual((0, node_fs_1.existsSync)(runnableCompiled), true);
                node_assert_1.default.strictEqual((0, node_fs_1.existsSync)(staleCompiled), false);
        ...
        (0, node_test_1.test)('does not rewrite runnable compiled tests', async () => {
            await withTempProject(async ({ projectDir, sourceDir, distDir }) => {
                ...
                node_assert_1.default.deepStrictEqual(runnableFiles, [runnableCompiled]);
                node_assert_1.default.strictEqual(await (0, promises_1.readFile)(runnableCompiled, 'utf8'), 'compiled test');
                node_assert_1.default.deepStrictEqual(logs, []);
            });
        });
        (0, node_test_1.test)('throws when compiled test is older than source test', async () => {
            await withTempProject(async ({ projectDir, sourceDir, distDir }) => {
                ...
                node_assert_1.default.throws(() => (0, suite_1.removeCompiledTestsWithoutSource)([staleCompiled], {
                    distDir,
                    sourceDir,
                    projectDir
                }), {
                ...
                node_assert_1.default.strictEqual((0, node_fs_1.existsSync)(staleCompiled), true);
            });
        });
    });
});

...
class TinkoffInvestNodeSDK {
    ...
    constructor(options) {
        ...
        this.throttle = new unary_throttle_service_1.Throttle(config_1.defaultConfig.unaryLimits);
        this.channel = (0, grpc_1.createSdkChannel)(this.options);
        this.metadata = (0, grpc_1.createSdkMetadata)(this.options);
    }
    get instruments() {
    ...
    useServiceAsClient(service) {
        ...
        if (!client) {
            client = (0, grpc_1.createSdkClient)(service, this.channel, this.metadata, this.options.trackLimits ?? true, this.throttle);

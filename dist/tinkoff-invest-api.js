    ...
    */
    ...
    async *middleware(call, options) {
        if (!call.responseStream) {
            if (exports.throttle.reduce() === false) {
...
//# sourceMappingURL=tinkoff-invest-api.js.map
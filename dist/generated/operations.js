...
exports.PortfolioResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.totalAmountOptions !== undefined) {
            common_1.MoneyValue.encode(message.totalAmountOptions, writer.uint32(74).fork()).ldelim();
        }
        if (message.totalAmountSp !== undefined) {
            common_1.MoneyValue.encode(message.totalAmountSp, writer.uint32(82).fork()).ldelim();
        }
        if (message.totalAmountPortfolio !== undefined) {
            common_1.MoneyValue.encode(message.totalAmountPortfolio, writer.uint32(90).fork()).ldelim();
        }
...
exports.PortfolioPosition = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.blockedLots !== undefined) {
            common_1.Quotation.encode(message.blockedLots, writer.uint32(178).fork()).ldelim();
        }
        if (message.positionUid !== "") {
        ...
        if (message.varMargin !== undefined) {
            common_1.MoneyValue.encode(message.varMargin, writer.uint32(210).fork()).ldelim();
        }
        if (message.expectedYieldFifo !== undefined) {
            common_1.Quotation.encode(message.expectedYieldFifo, writer.uint32(218).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.VirtualPortfolioPosition = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.quantity !== undefined) {
            common_1.Quotation.encode(message.quantity, writer.uint32(42).fork()).ldelim();
        }
        if (message.averagePositionPrice !== undefined) {
            common_1.MoneyValue.encode(message.averagePositionPrice, writer.uint32(50).fork()).ldelim();
        }
        if (message.expectedYield !== undefined) {
            common_1.Quotation.encode(message.expectedYield, writer.uint32(58).fork()).ldelim();
        }
        if (message.expectedYieldFifo !== undefined) {
            common_1.Quotation.encode(message.expectedYieldFifo, writer.uint32(66).fork()).ldelim();
        }
        if (message.expireDate !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.expireDate), writer.uint32(74).fork()).ldelim();
        }
        if (message.currentPrice !== undefined) {
            common_1.MoneyValue.encode(message.currentPrice, writer.uint32(82).fork()).ldelim();
        }
        if (message.averagePositionPriceFifo !== undefined) {
            common_1.MoneyValue.encode(message.averagePositionPriceFifo, writer.uint32(90).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.GetDividendsForeignIssuerRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.getDivForeignIssuerReport !== undefined) {
            exports.GetDividendsForeignIssuerReportRequest.encode(message.getDivForeignIssuerReport, writer.uint32(18).fork())
                .ldelim();
        }
        return writer;
    },
...
exports.PortfolioStreamResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.ping !== undefined) {
            common_1.Ping.encode(message.ping, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.GetOperationsByCursorRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.from !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.from), writer.uint32(50).fork()).ldelim();
        }
        if (message.to !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.to), writer.uint32(58).fork()).ldelim();
        }
...
exports.OperationItem = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.payment !== undefined) {
            common_1.MoneyValue.encode(message.payment, writer.uint32(330).fork()).ldelim();
        }
        if (message.price !== undefined) {
            common_1.MoneyValue.encode(message.price, writer.uint32(338).fork()).ldelim();
        }
        if (message.commission !== undefined) {
            common_1.MoneyValue.encode(message.commission, writer.uint32(346).fork()).ldelim();
        }
        if (message.yield !== undefined) {
            common_1.MoneyValue.encode(message.yield, writer.uint32(354).fork()).ldelim();
        }
        if (message.yieldRelative !== undefined) {
            common_1.Quotation.encode(message.yieldRelative, writer.uint32(362).fork()).ldelim();
        }
        if (message.accruedInt !== undefined) {
            common_1.MoneyValue.encode(message.accruedInt, writer.uint32(370).fork()).ldelim();
        }
        if (message.quantity !== 0) {
        ...
        if (message.cancelDateTime !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.cancelDateTime), writer.uint32(450).fork()).ldelim();
        }
...
exports.OperationItemTrade = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.date !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.date), writer.uint32(50).fork()).ldelim();
        }
        if (message.quantity !== 0) {
            writer.uint32(88).int64(message.quantity);
        }
        if (message.price !== undefined) {
            common_1.MoneyValue.encode(message.price, writer.uint32(130).fork()).ldelim();
        }
        if (message.yield !== undefined) {
            common_1.MoneyValue.encode(message.yield, writer.uint32(170).fork()).ldelim();
        }
        if (message.yieldRelative !== undefined) {
            common_1.Quotation.encode(message.yieldRelative, writer.uint32(178).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.PositionsMoney = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.availableValue !== undefined) {
            common_1.MoneyValue.encode(message.availableValue, writer.uint32(10).fork()).ldelim();
        }
        if (message.blockedValue !== undefined) {
            common_1.MoneyValue.encode(message.blockedValue, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {

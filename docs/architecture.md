...
`instruments get-bond-coupons`, `instruments get-brand-by`, `instruments get-brands`,
`instruments get-countries`, `instruments get-dividends`,
`instruments get-favorites`, `instruments get-futures-margin`,
`instruments get-instrument-by`, `instruments trading-schedules`,

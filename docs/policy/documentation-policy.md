...
- CLI entrypoint: `src/cli.ts`, `src/bootstrap/cli-runner.ts`, `src/bootstrap/args/**`, `src/bootstrap/command-registry.ts`, `src/bootstrap/commands/**`, `src/bootstrap/help/**`, `src/bootstrap/version.ts`;
